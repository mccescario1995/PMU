...
<template>
  <div class="p-6 space-y-6">
    ...
    <UTable :data="transactions" :columns="columns" :loading="loading" :pagination-options="{ getPaginationRowModel: getPaginationRowModel() }" v-model:pagination="tablePagination" />
